 ...
 */
class Version0006PricesBackToInt extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE bottle CHANGE acquisition_price acquisition_price VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE estimation_price estimation_price VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE volume volume VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE storage_location storage_location VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
