...
class Version0001Init extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', username VARCHAR(25) NOT NULL, password VARCHAR(64) NOT NULL, email VARCHAR(64) NOT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bottle (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', wine_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', acquisition_price DOUBLE PRECISION DEFAULT NULL, estimation_price DOUBLE PRECISION DEFAULT NULL, volume VARCHAR(255) DEFAULT NULL, storage_location VARCHAR(255) DEFAULT NULL, INDEX IDX_ACA9A95528A2BD76 (wine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE wine (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', name VARCHAR(255) NOT NULL, designation VARCHAR(255) NOT NULL, varietal VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, vintage INT NOT NULL, country VARCHAR(255) NOT NULL, region VARCHAR(255) NOT NULL, winemaker VARCHAR(255) NOT NULL, rating INT DEFAULT NULL, comment LONGTEXT DEFAULT NULL, food_pairing LONGTEXT DEFAULT NULL, reference VARCHAR(255) DEFAULT NULL, classification_level VARCHAR(255) DEFAULT NULL, aging VARCHAR(255) DEFAULT NULL, best_aging VARCHAR(255) DEFAULT NULL, best_after VARCHAR(255) DEFAULT NULL, drink_after VARCHAR(255) DEFAULT NULL, alcohol_degree DOUBLE PRECISION DEFAULT NULL, temperature DOUBLE PRECISION DEFAULT NULL, batch VARCHAR(255) DEFAULT NULL, category VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
