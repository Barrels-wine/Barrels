...
class Varietals
{
    ...
    public const BRAQUET_N = 'Braquet';
    ...
    public const ETRAIRE_DE_L_ADUI_N = 'Etraire de L\'Aduï';
    public const FER_SERVADOU_N = 'Fer Servadou';
    ...
    public static function getConstants()
    {
        return [
            ...
            self::ABONDANT_B,
            self::ABOURIOU_N,
            self::ADMIRABLE_DE_COURTILLER,
            self::AGLIANICO,
            self::AIREN,
            self::ALBARINO_B,
            self::ALCANON,
            self::ALEATICO_N,
            self::ALICANTE_HENRI_BOUSCHET_N,
            self::ALICANTE_N,
            self::ALIGOTE_B,
            self::ALPHONSE_LAVALLEE_N,
            self::ALTESSE,
            self::ALTESSE_B,
            self::AMIGNE,
            ...
            self::BRUNELLO,
            self::BUAL,
            self::CABERNET_FRANC_N,
            self::CABERNET_SAUVIGNON_N,
            self::CALADOC_N,
            self::CALITOR_N,
            self::CAMARALET_B,
            self::CANAIOLO,
            ...
            self::FIANO,
            self::FOLIGNAN_B,
            self::FOLLE_BLANCHE_B,
            self::FRANC_NOIR_DE_HAUTE_SAONE_N,
            self::FRANKONIA,
            self::FRANKOVKA,
            self::FRAPPATO_DI_VITTORIA,
            self::FREISA,
            self::FRIULANO,
            self::FUELLA_NERA_N,
            self::FURMINT_B,
            self::GAGLIOPPO,
            self::GAMARET_N,
            self::GAMAY_DE_BOUZE_N,
            self::GAMAY_DE_CHAUDENAY_N,
            self::GAMAY_FREAUX,
            self::GAMAY_N,
            self::GAMZA,
            self::GANSON_N,
            ...
            self::GRIGNOLINO,
            self::GRINGET_B,
            self::GROLLEAU_GRIS_G,
            self::GROLLEAU_N,
            self::GROPPELLO_BIANCO,
            self::GROPPELLO_DI_MOCASINA,
            self::GROPPELLO_DI_SANTO_STEFANO,
            self::GROPPELLO_GENTILE,
            self::GROS_COLMAN,
            self::GROS_MANSENG_B,
            self::GROS_MESLIER_B,
            self::GROS_NOIR_DES_BENI_ABBES,
            self::GROS_VERT,
            self::GRUNER_VELTLINER,
            self::GUTEDEL,
            self::HARSLEVELU,
            self::HIBOU,
            self::HUMAGNE_BLANCHE,
            self::HUMAGNE_ROUGE,
            self::INCROCIO_MANZONI,
            self::JACQUERE_B,
            self::JACQUEZ,
            self::JAOUMET,
            self::JOHANNISBERG,
            ...
            self::LISTAN_B,
            self::LIVAL_N,
            self::LLEDONER_PELUT_N,
            self::LOUREIRO,
            self::MACABEO,
            self::MACABEU_B,
            self::MADELEINE_OBERLIN,
            self::MALAGA_B,
            self::MALBEC,
            self::MALVASIA,
            self::MALVOISIE,
            ...
            self::NEGRETTE_N,
            self::NEGROAMARO,
            self::NERELLO_CAPPUCCIO,
            self::NERELLO_MANTELLATO,
            self::NERELLO_MASCALESE,
            self::NERETTIA_CUNEESE,
            self::NERETTO_DI_BAIRO,
            self::NERO_AVOLA,
            self::NIELLUCCIO_N,
            self::NOAH,
            self::NOIR_DE_LISTAN,
            self::NOIR_FLEURIEN_N,
            self::NONAY,
            self::ODJALESCHI,
            self::OKUZGOZU,
            self::OLIVETTE_BLANCHE,
            self::OLIVETTE_NOIRE,
            self::ONDENC_B,
            self::PAGADEBITI_B,
            self::PAIEN,
            ...
            self::PERSAN_N,
            self::PETIT_COURBU_B,
            self::PETIT_MANSENG_B,
            self::PETIT_MESLIER_B,
            self::PETIT_VERDOT_N,
            self::PETITE_ARVINE,
            self::PETITE_SYRAH,
            self::PICARDAN_B,
            ...
            self::PIGNEROL_B,
            self::PIGNOLETTO,
            self::PINEAU_D_AUNIS_N,
            self::PINITAGE,
            self::PINOT_AUXERROIS,
            self::PINOT_BIANCO,
            self::PINOT_BLANC_B,
            ...
            self::PIQUEPOUL_GRIS_G,
            self::PIQUEPOUL_NOIR_N,
            self::PLANT_DROIT_N,
            self::PLAVAC_MALI,
            self::POINTU_DE_VIMINES,
            self::PORTAN_N,
            self::PORTUGAIS_BLEU_N,
            self::POULSARD_N,
            self::PRECOCE_BOUSQUET_B,
            self::PRECOCE_DE_MALINGRE_B,
            self::PRIMITIVO,
            self::PRIN_B,
            self::PROSECCO,
            self::PRUGNOLO_GENTILE,
            self::PRUNELARD_N,
            self::RABO,
            self::RAFFIAT_DE_MONCADE_B,
            self::REFOSCO,
            self::REGENT,
            self::REGINA,
            self::REINE_DES_VIGNES,
            self::RIBIER,
            self::RIBOL_N,
            self::RIESLING_B,
            self::RIESLING_ITALIEN,
            self::RIMINESE_B,
            ...
            self::SAINT_JEANNET,
            self::SAINT_LAURENT,
            self::SAINT_MACAIRE_N,
            self::SAINT_PIERRE_DORE_B,
            self::SANGIOVESE,
            self::SAPERAVI,
            self::SAUVIGNON,
            self::SAUVIGNON_B,
            ...
            self::VALDIGUIE_N,
            self::VALENSY_N,
            self::VELTELINER_ROUGE_PRECOCE_RS,
            self::VERDAL,
            self::VERDAOU,
            self::VERDEJO,
            self::VERDELHO,
